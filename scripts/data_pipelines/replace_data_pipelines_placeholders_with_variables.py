...
from _data_pipelines_manipulation import replace_data_pipeline_placeholders_with_variables
...
modified_content = replace_data_pipeline_placeholders_with_variables(data_pipeline_path, variables)
